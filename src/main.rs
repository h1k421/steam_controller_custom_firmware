...
#[inline]
pub fn modify_pdruncfg<F>(peripherals: &mut Peripherals, f: F)
where
    F: FnOnce(&mut lpc11uxx::syscon::pdruncfg::W) -> &mut lpc11uxx::syscon::pdruncfg::W,
{
    unsafe {
        peripherals
            .SYSCON
            .pdruncfg
            .modify(|reader, writer| f(writer.bits(reader.bits() | 0xE800)));
    }
}
